...
export default function Page(){
   ...
   const setLoader = ()=>{
    ...
    return(
        <div className="flex flex-col flex-1 gap-5 items-center mt-10 pl-10 mb-20">
           ...
           <Dialog>
             ...
             <DialogContent className="bg-black/60 backdrop-blur-md flex flex-col items-center justify-center">
               <DialogHeader>
                  ...
                  (
                     <div>
                        <DialogTitle className='text-white'>Verification Successful 🎉 ! Eligible For Loan Id:25</DialogTitle>
                 <DialogDescription>
