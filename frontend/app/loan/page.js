                    ...
                    <DialogContent className="fixed mt-[300px] ml-[800px] inset-0 flex flex-col items-center justify-center bg-black/60 backdrop-blur-md">
                      ...
                      >
                        ...
                        <div className="flex justify-center mt-4">
                          <Button variant='soft' className='p-6 hover:bg-blue-200 hover:cursor-pointer' color='violet'>Submit Request</Button>
                        </div>
                      </form>
                    </DialogContent>
                  </Dialog>
              ...
              <div className="flex flex-col gap-5 ">
                {(borrow_requests_for_assigned_loan.borrow_requests).map((request =>(
                  ...
                  <CardFooter >
                    ...
                    {(borrow_requests_for_assigned_loan.loan_status == "Assigned"?(
